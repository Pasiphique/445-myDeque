...
// Assig1B-out.txt
//Make sure you put comments into all of your files. Minimally this should include your name and the
//course, and also a brief explanation of each file (at the top of the file). Also include comments to explain
//any code that is not obvious.
...
public class Assig1B {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Contents: " + D1.toString());
        ...
        System.out.println("Contents: " + D2.toString());
        System.out.println();
